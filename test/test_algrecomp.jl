@testitem "Testing algebraic recompression of single butterfly compressed blocks" begin
    ...
    RBfly1 = ButterflyFactorization.recompress_BF(Bfly1, 10^(-2))
    size1r = Base.summarysize(RBfly1)
    RBfly2 = ButterflyFactorization.recompress_BF(Bfly2, 10^(-2))
    size2r = Base.summarysize(RBfly2)
    RBfly3 = ButterflyFactorization.recompress_BF(Bfly3, 10^(-2))
    size3r = Base.summarysize(RBfly3)
    RBfly4 = ButterflyFactorization.recompress_BF(Bfly4, 10^(-2))
